export const defaultSiteSettings = {
  ...
  announcementLinkLabelUz: "Katalog",
  announcementLinkLabelRu: "Каталог",
  announcementLinkLabelEn: "Catalog",
  announcementLink: "/ru/catalog",
  footerPhone: "+998 90 999-99-99",
  footerEmail: "modaily_cis@gmail.com",
  ...
  aboutTitleUz: "O MODAILY",
  aboutTitleRu: "О MODAILY",
  aboutTitleEn: "ABOUT MODAILY",
  aboutDescriptionUz:
  ...
  aboutBrandTitleUz: "MODAILY",
  aboutBrandTitleRu: "MODAILY",
  aboutBrandTitleEn: "MODAILY",
  aboutPanelDescriptionUz:
  ...
  aboutPanelSecondaryDescriptionUz:
  ...
  aboutPanelSecondaryDescriptionRu:
  ...
  aboutPanelSecondaryDescriptionEn:
  ...
  aboutImageUrl: "/images/Galary/about1.png",
  newsletterTitleUz: "Yangiliklarimizga obuna bo'ling",
  newsletterTitleRu: "Подпишитесь на наши новости",
  newsletterTitleEn: "Subscribe to our updates",
  newsletterPlaceholderUz: "Elektron pochtangizni kiriting",
  newsletterPlaceholderRu: "Введите электронную почту",
...
export const defaultHomeHero = {
  ...
  badgeRu: "Новинка",
  badgeEn: "New arrival",
  titleUz: "Balancing Foam Cleanser",
  titleRu: "Balancing Foam Cleanser",
  titleEn: "Balancing Foam Cleanser",
  descriptionUz: "Teri barrieriga zarar bermasdan chuqur tozalovchi kundalik ko'pik.",
  descriptionRu: "Глубоко очищающая пенка для лица, которая не нарушает барьерную функцию кожи.",
  descriptionEn: "A deep-cleansing daily foam that respects the skin barrier.",
  primaryCtaUz: "Batafsil",
  primaryCtaRu: "Подробно",
  primaryCtaEn: "Learn more",
  primaryCtaLink: "/ru/catalog",
  secondaryCtaUz: "Katalog",
