...
export function FallbackImage({ src, fallbackSrc, alt, className }: FallbackImageProps) {
  const inlineFallback = `data:image/svg+xml;utf8,${encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800">
      ...
      <rect x="530" y="175" width="140" height="110" rx="28" fill="#bf1730"/>
      ...
      <rect x="520" y="610" width="160" height="16" rx="8" fill="#bf1730" opacity="0.9"/>
      <text x="600" y="700" fill="#bf1730" font-size="46" font-family="Arial, Helvetica, sans-serif" text-anchor="middle">${alt}</text>
    </svg>`
  )}`;
